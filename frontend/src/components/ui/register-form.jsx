...
export default function RegisterForm({ onRegister }) {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-zinc-950">
      ...
      <div className="w-full md:w-1/2 lg:w-[42%] flex flex-col items-center justify-center bg-zinc-950 px-6 sm:px-10 py-8 overflow-y-auto relative">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-[340px] flex flex-col relative z-10">
          <div className="mb-6">
            ...
            <p className="text-zinc-500 text-sm mt-1.5">Join the community — it's completely free</p>
          </div>
          ...
          <div className="flex gap-2.5">
            <div className={`${inputRow} flex-1`}>
              ...
              <input
                ...
                onChange={handleChange} placeholder="First" autoComplete="given-name"
            ...
            <div className={`${inputRow} flex-1`}>
              <input
                ...
                onChange={handleChange} placeholder="Last" autoComplete="family-name"
                className="bg-transparent text-white placeholder-zinc-600 outline-none text-sm w-full h-full"
                required
              />
            </div>
