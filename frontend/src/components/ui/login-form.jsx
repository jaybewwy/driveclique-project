...
export default function LoginForm({ onLogin }) {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-zinc-950">
      ...
      <main id="main-content" className="w-full md:w-1/2 lg:w-[42%] flex flex-col items-center justify-center bg-zinc-950 px-6 sm:px-10 py-12 relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-[340px] flex flex-col relative z-10">
          ...
          {/* Error banner */}
          {error && (
            <div id="login-error" role="alert" className="mb-5 bg-red-500/10 border border-red-500/30 rounded-xl px-4 py-3 flex items-start gap-2">
          ...
          <div className="flex items-center justify-between mt-4 text-xs">
            <label className="flex items-center gap-2 text-zinc-400 cursor-pointer select-none hover:text-zinc-400 transition-colors">
