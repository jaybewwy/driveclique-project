    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="flex max-w-7xl mx-auto">
        ...
        <div className="flex-1 max-w-2xl border-r border-zinc-800 min-h-screen p-6">
          ...
          <div className="space-y-6">
            <div className="bg-zinc-900 rounded-3xl p-6">
              <h3 className="font-semibold">Angeles Crest Highway Run</h3>
              <p className="text-zinc-400 text-sm">March 15 • La Cañada Flintridge</p>
              <p className="mt-4 text-zinc-300">Who's joining this Saturday night run?</p>
              <div className="flex gap-3 mt-6">
                <button className="flex-1 bg-green-600 py-3 rounded-2xl">Going</button>
                <button className="flex-1 bg-yellow-600 py-3 rounded-2xl">Maybe</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-80 hidden xl:block p-6 sticky top-16 h-screen overflow-y-auto">
          ...
          <div className="mt-10">
            <h3 className="font-semibold mb-4">Upcoming Drives</h3>
            <div className="text-sm text-zinc-400">No upcoming drives yet</div>
          </div>
        </div>
      </div>
    </div>
